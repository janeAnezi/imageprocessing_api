...
routes.get('/images', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var queryParameters, filename, width, height, exactName, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, (0, files_1.resizeImage)(filename, width, height)];
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, files_1.fileName)(filename)];
            case 3:
                exactName = _a.sent();
                res.sendFile("".concat(app_root_path_1.default.path, "/images/thumb/").concat(exactName));
                return [3 /*break*/, 5];
            case 4:
                e_1 = _a.sent();
                res.status(400).send({
